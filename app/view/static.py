...
_COMPATIBILITY_REDIRECT_WILDCARDS = {
    "*hardware_design_recommendations*": "https://forum.opencyphal.org/t/removal-of-the-physical-layer-specification/895",
...
def _not_found(_error):
    ...
    return (
        render_template("http_error.html", error_description="File not found (404)"),
        404,
    )
